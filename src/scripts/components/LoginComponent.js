...
export default class LoginComponent extends Component{
    ...
    render() {
        ...
        form.addEventListener('submit', event => {
            ...
            // let email = event.target.querySelector('input[type="email"]')
            // let password = event.target.querySelector('input[type="password"]')
            // let btnLogin = event.target.querySelector('.btn')
            // let user = {
            //     email: email.value,
            //     password: password.value
            // }
